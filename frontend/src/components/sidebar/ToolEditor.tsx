  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2 pb-3 border-b border-[var(--color-border-subtle)]">
        <div className="w-5 h-5 rounded-md bg-[var(--color-info-subtle)] flex items-center justify-center">
          <svg className="w-3 h-3 text-[var(--color-info)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="pt-3 border-t border-[var(--color-border-subtle)]">
        <div className="flex items-center gap-2 mb-2">
          <svg className="w-3.5 h-3.5 text-[var(--color-info)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <div key={arg.name} className="flex items-center gap-2">
                      ...
                      {inputType === "checkbox" ? (
                        <input
                          ...
                          className="rounded border-[var(--color-border-default)] text-[var(--color-info)] focus:ring-[var(--color-info)] bg-[var(--color-base)]"
                        />
                      ) : inputType === "textarea" ? (
                        <textarea
