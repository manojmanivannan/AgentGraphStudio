...
export function ProducedAttachmentCard({
  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-lg border border-[var(--color-success)]/20 bg-[var(--color-base)] px-3 py-2 text-[var(--color-text-primary)]">
